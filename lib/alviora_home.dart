...
import 'call_screen.dart'; // Make sure this file exists in the same directory or adjust path
                            ...
                            Flexible(
                              child: GestureDetector(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => CallScreen(callId: 'your_call_id_here')),
                                  );
                                },
                                child: const AppCard(icon: Icons.call, label: 'Connect\nwith Family'),
                              ),
                            ),
                            const Flexible(child: AppCard(icon: Icons.list, label: 'Status')),
                            const Flexible(child: AppCard(icon: Icons.monitor_heart, label: 'Status')),
                            const Flexible(child: AppCard(icon: Icons.emoji_emotions, label: 'Mood Booster\nMode')),
                          ],
                        ),
                      ),
                    ),
